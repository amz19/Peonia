...
public class JSaver extends JPanel implements StateListener {
    ...
    private void initComponents() {
        ...
        jbtnNew.setMargin(new java.awt.Insets(7, 28, 7, 28));
        jbtnNew.setPreferredSize(new java.awt.Dimension(45, 30));
        ...
        jbtnDelete.setMargin(new java.awt.Insets(7, 28, 7, 28));
        jbtnDelete.setPreferredSize(new java.awt.Dimension(45, 30));
        ...
        jbtnSave.setMargin(new java.awt.Insets(7, 28, 7, 28));
        jbtnSave.setPreferredSize(new java.awt.Dimension(45, 30));
