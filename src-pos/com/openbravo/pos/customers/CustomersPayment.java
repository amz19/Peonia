...
public class CustomersPayment extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    private void printTicket(String resname, TicketInfo ticket, CustomerInfoExt customer) {
        ...
        if (resource == null) {
            ...
            try {
                ...
                ///Date curdate = customer.getCurdate();
                ///Para imprimir el nombre del host en el ticket.
                ScriptEngine script = ScriptFactory.getScriptEngine(ScriptFactory.VELOCITY);
                ///Para imprimir el nombre del host en el ticket.
                script.put("host", host);
                ///script.put("curdate", curdate);
                ///Para imprimir el nombre del host en el ticket.
    ...
    private void initComponents() {
        ...
        m_jKeys.setForeground(new java.awt.Color(240, 240, 240));
        m_jKeys.setEnabled(false);
        m_jKeys.setOpaque(false);
        m_jKeys.setRequestFocusEnabled(false);
        m_jKeys.setVerifyInputWhenFocusTarget(false);
        ...
        editorcard.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        editorcard.setForeground(new java.awt.Color(240, 240, 240));
        editorcard.setEnabled(false);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNotes, javax.swing.GroupLayout.PREFERRED_SIZE, 338, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(txtTaxId, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtName, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtCard, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 305, Short.MAX_VALUE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtMaxdebt, javax.swing.GroupLayout.DEFAULT_SIZE, 98, Short.MAX_VALUE)
                            .addComponent(txtCurdebt)
                            .addComponent(txtCurdate))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtNotes, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayActionPerformed
        ...
        /////////////
        /////////////if (paymenitdialog.showDialog(customerext.getCurdebt())) {
        /////////////
