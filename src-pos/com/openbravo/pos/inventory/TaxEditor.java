...
public class TaxEditor extends JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        setLayout(null);
        add(m_jName);
        m_jName.setBounds(170, 20, 200, 20);
        ...
        add(m_jRate);
        m_jRate.setBounds(170, 170, 60, 20);
        ...
        add(jLabel4);
        jLabel4.setBounds(20, 110, 220, 14);

        jLabel5.setText(AppLocal.getIntString("label.taxparent")); // NOI18N
        add(jLabel5);
        jLabel5.setBounds(20, 140, 220, 14);

        jCascade.setText(AppLocal.getIntString("label.cascade")); // NOI18N
        add(jCascade);
        jCascade.setBounds(234, 168, 110, 23);
        add(m_jTaxCategory);
        m_jTaxCategory.setBounds(170, 50, 200, 20);
        add(m_jTaxParent);
        m_jTaxParent.setBounds(170, 140, 200, 20);
        add(m_jCustTaxCategory);
        m_jCustTaxCategory.setBounds(170, 110, 200, 20);

        jLabel6.setText(AppLocal.getIntString("label.order")); // NOI18N
        add(jLabel6);
        jLabel6.setBounds(20, 200, 130, 14);
        add(jOrder);
        jOrder.setBounds(170, 200, 60, 20);

        jLabel7.setText(AppLocal.getIntString("Label.ValidFrom")); // NOI18N
        add(jLabel7);
        jLabel7.setBounds(20, 80, 120, 14);
        add(txtValidFrom);
        txtValidFrom.setBounds(170, 80, 200, 20);
        ...
        add(btnValidFrom);
        btnValidFrom.setBounds(379, 78, 49, 25);
