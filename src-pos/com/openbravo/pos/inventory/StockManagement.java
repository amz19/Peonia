...
public class StockManagement extends JPanel implements JPanelView {
    ...
    public StockManagement(AppView app) {
        ...
        m_cat.getComponent().setPreferredSize(new Dimension(0, 350));//245));
    ...
    private void stateTransition(char cTrans) {
        if (cTrans == '\u007f' || cTrans == '\u232B') { //Unicode Character 'DELETE' cTrans == '\u007f'   || cTrans == '\u232b'  delete left
            m_jcodebar.setText(null);
    ...
    private void initComponents() {
        ...
        jPanel3.add(m_jdate);
        m_jdate.setBounds(100, 30, 200, 20);
        ...
        m_jbtndate.setBounds(310, 28, 40, 25);
        ...
        m_jreason.setBounds(100, 60, 200, 20);
        ...
        jPanel3.add(jPanel5);
        jPanel5.setBounds(10, 130, 502, 193);
        ...
        jEditAttributes.setMaximumSize(new java.awt.Dimension(54, 42));
        jEditAttributes.setMinimumSize(new java.awt.Dimension(54, 42));
        jEditAttributes.setPreferredSize(new java.awt.Dimension(54, 42));
        ...
        jEditAttributes.setBounds(520, 280, 54, 42);
