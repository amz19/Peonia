...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(240, 40, 70, 14);
        add(m_jRef);
        m_jRef.setBounds(90, 40, 130, 20);
        add(m_jName);
        m_jName.setBounds(300, 40, 328, 20);
        ...
        jPanel1.add(m_jTax);
        m_jTax.setBounds(160, 170, 170, 20);

        m_jmargin.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel1.add(m_jmargin);
        m_jmargin.setBounds(250, 82, 80, 20);
        ...
        m_jImage.setBounds(340, 20, 270, 210);
        ...
        m_jInCatalog.setBounds(160, 190, 80, 20);
        ...
        m_jstockcost.setBounds(100, 20, 80, 20);
        jPanel2.add(m_jScale);
        m_jScale.setBounds(98, 140, 80, 21);
        jPanel2.add(m_jComment);
        m_jComment.setBounds(98, 110, 80, 21);
        ...
        m_jCatalogOrder.setBounds(100, 80, 80, 20);
        ...
        jLabel13.setBounds(10, 50, 150, 14);
        jPanel2.add(m_jAtt);
        m_jAtt.setBounds(100, 50, 170, 20);
        ...
        add(jTabbedPane1);
        jTabbedPane1.setBounds(10, 70, 623, 260);
