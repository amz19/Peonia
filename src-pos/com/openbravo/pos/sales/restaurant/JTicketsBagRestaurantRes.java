...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 180, 80, 14);

        jLabel4.setText(AppLocal.getIntString("rest.label.notes")); // NOI18N
        jPanel1.add(jLabel4);
        jLabel4.setBounds(10, 210, 80, 14);
        jPanel1.add(m_jtxtDescription);
        m_jtxtDescription.setBounds(90, 210, 300, 130);

        m_jtxtChairs.setPreferredSize(new java.awt.Dimension(25, 25));
        jPanel1.add(m_jtxtChairs);
        m_jtxtChairs.setBounds(90, 180, 70, 20);
        jPanel1.add(txtCustomer);
        txtCustomer.setBounds(90, 150, 300, 20);
        ...
        jButton1.setBounds(390, 150, 48, 24);
