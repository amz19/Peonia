...
public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(m_jMinDate, javax.swing.GroupLayout.DEFAULT_SIZE, 233, Short.MAX_VALUE)
                    .addComponent(m_jSequence))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(m_jMaxDate, javax.swing.GroupLayout.PREFERRED_SIZE, 251, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(38, 38, 38))
        );
        ...
        m_jCash.setFont(new java.awt.Font("Tahoma", 0, 39)); // NOI18N
        m_jCash.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        m_jCash.setPreferredSize(new java.awt.Dimension(12, 54));
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(m_jCount, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(m_jCash, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(m_jScrollTableTicket, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        m_jSalesTotal.setFont(new java.awt.Font("Tahoma", 0, 39)); // NOI18N
        m_jSalesTotal.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        m_jSalesTotal.setPreferredSize(new java.awt.Dimension(12, 54));
        ...
        m_jSalesTaxes.setForeground(new java.awt.Color(240, 240, 240));
        m_jSalesTaxes.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        m_jSalesTaxes.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        m_jSalesTaxes.setDisabledTextColor(new java.awt.Color(240, 240, 240));
        m_jSalesTaxes.setEnabled(false);
        m_jSalesTaxes.setPreferredSize(new java.awt.Dimension(0, 0));

        m_jSalesSubtotal.setEditable(false);
        m_jSalesSubtotal.setForeground(new java.awt.Color(240, 240, 240));
        m_jSalesSubtotal.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        m_jSalesSubtotal.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        m_jSalesSubtotal.setDisabledTextColor(new java.awt.Color(240, 240, 240));
        m_jSalesSubtotal.setEnabled(false);
        m_jSalesSubtotal.setOpaque(false);
        m_jSalesSubtotal.setPreferredSize(new java.awt.Dimension(0, 0));
        m_jSalesSubtotal.setRequestFocusEnabled(false);
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(m_jSales, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(95, 95, 95)
                        .addComponent(m_jSalesTaxes, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(30, 30, 30)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addComponent(m_jSalesSubtotal, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(m_jSalesTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void m_jCloseCashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jCloseCashActionPerformed
        ...
        if (res == JOptionPane.YES_OPTION) {
            ...
            //Para lanzar el script de backup; solo cuando se cierra el POS.  
//            String SO = System.getProperty("os.name");
//            if( SO.regionMatches( true, 0, "Windows", 0, 7 ) )
//                try {
//                    ///Windows...
//                    Process p = Runtime.getRuntime().exec("cmd /C start C:/MiscelaneosPOS/Scripts/BackUpFullWindows.bat");
//                } catch (IOException e) {  
//                    e.printStackTrace();  
//                    //throw new RuntimeException(e);APP_ID
//            } else {
//                try {
//                    ///Linux...
//                    Process p = Runtime.getRuntime().exec("uxterm -e /opt/MiscelaneosPOS-2.30.2/Scripts/BackUpFullLinux.sh"); //sh /opt/Muce Punto de venta-2.30.2/Scripts/BackUpFullLinux.sh
//                } catch (IOException e) {  
//                    e.printStackTrace();  
