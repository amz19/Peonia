...
public class JRootApp extends JPanel implements AppView {
    ...
    public boolean initApp(AppProperties props) {
        ...
        m_jHost.setText("<html>" + m_props.getHost() + " - " + sWareHouse + " - " + "El día de hoy es:" + DateFormat.getDateInstance(DateFormat.FULL).format(date) + " y son las:" + DateFormat.getTimeInstance(DateFormat.DEFAULT).format(date) + ".");
        //m_jHost.setText("<html>" + m_props.getHost() + ". - " + sWareHouse + " - " + ">>>---El día de hoy es:" + DateFormat.getDateInstance(DateFormat.FULL).format(date) + " y son las:" + DateFormat.getTimeInstance(DateFormat.DEFAULT).format(date) + ".--->>>.");
        //m_jHost.setText("<html>" + m_props.getHost() + " - " + sWareHouse + "<br>" + url); + DateUtils.getTodayMinutes() DateFormat.getDateInstance(DateFormat.FULL).format(date);
    ...
    public void tryToClose() {   
        ...
        String SO = System.getProperty("os.name");
            ////if( SO.regionMatches( true, 0, "Windows", 0, 7 ) )
                ////try {
                    ///Windows...
                  ////Process p = Runtime.getRuntime().exec("cmd /C start C:/PeoniaPOS/Scripts/BackUpFullWindows.bat");               
//                    Runtime rt = Runtime.getRuntime();
//                    String filePath = "\"C:\\PeoniaPOS\\Scripts\\BackUpFullWindows.bat\"";
...
//                    Process pr = rt.exec(commands);
            ...
            ////} else {
                ////try {
                    ///Linux...
                    ////Process p = Runtime.getRuntime().exec("uxterm -e /opt/PeoniaPOS-2.30.2/Scripts/BackUpFullLinux.sh"); //sh /opt/Muce Punto de venta-2.30.2/Scripts/BackUpFullLinux.sh
                ////} catch (IOException e) {  
                    ////e.printStackTrace();  
    ...
    private void listPeople() {
        ...
        try {
            ...
            for (int i = 0; i < people.size(); i++) {
                ...
                btn.setMaximumSize(new Dimension(250, 75));
                btn.setPreferredSize(new Dimension(250, 75));
                btn.setMinimumSize(new Dimension(250, 75));
    ...
    private void initComponents() {
        ...
        m_jLblTitle.setFont(new java.awt.Font("PMingLiU", 1, 35)); // NOI18N
        ...
        jLabel2.setFont(new java.awt.Font("PMingLiU", 1, 39)); // NOI18N
        jLabel2.setText("PeoniaPOS.");
        jLabel2.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jLabel2.setPreferredSize(new java.awt.Dimension(309, 30));
        ...
        jPanel4.setMaximumSize(new java.awt.Dimension(1600, 1550));
        jPanel4.setMinimumSize(new java.awt.Dimension(1600, 1550));
        jPanel4.setPreferredSize(new java.awt.Dimension(1600, 1550));
        ...
        jLabel1.setAlignmentX(1000.0F);
        jLabel1.setAlignmentY(100.0F);
        jLabel1.setBorder(javax.swing.BorderFactory.createEmptyBorder(20, 1, 1, 1));
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jLabel1.setMaximumSize(new java.awt.Dimension(1600, 1593));
        jLabel1.setMinimumSize(new java.awt.Dimension(1600, 1593));
        jLabel1.setPreferredSize(new java.awt.Dimension(1600, 1600));
        jLabel1.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jPanel4.add(jLabel1);

        m_jPanelLogin.add(jPanel4, java.awt.BorderLayout.CENTER);

        jPanel5.setPreferredSize(new java.awt.Dimension(900, 180));

        m_jLogonName.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
        m_jLogonName.setPreferredSize(new java.awt.Dimension(960, 180));
        m_jLogonName.setLayout(new java.awt.BorderLayout());

        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        jScrollPane1.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        jScrollPane1.setPreferredSize(new java.awt.Dimension(555, 185));
        ...
        m_jClose.setPreferredSize(new java.awt.Dimension(130, 40));
