...
public class JPaymentCashPos extends javax.swing.JPanel implements JPaymentInterface {
    ...
    Double value = m_jTendered.getDoubleValue();
        if (value == null || value == 0.0) {
            m_dPaid = 0; /////////////Para deshabilitar el boton de acepatar al pagar.///m_dTotal;
        } else {            
            m_dPaid = value;
        }   
        ...
        //////////////
        m_dChange = m_dPaid - m_dTotal;
        //ticket.getChange() =  m_dPaid - m_dTotal;
        /////////////
    }
    ...
    private void initComponents() {
        ...
        m_jTendered.setBackground(java.awt.Color.white);
