...
public abstract class JPaymentSelect extends javax.swing.JDialog 
    ...
    ///////////        
    ///////////public boolean showDialog(double total, double pagado, double cambio, CustomerInfoExt customerext) {
    ///////////
    public boolean showDialog(double total, CustomerInfoExt customerext) {    
        ...
        if (m_jTabPayment.getTabCount() == 0) {
            ...
            /////////////
            ////////////m_aPaymentInfo.add(getDefaultPayment(total, pagado, cambio));
            ////////////
    ...
    /////////////
    /////////////protected abstract PaymentInfo getDefaultPayment(double total, double pagado, double cambio);
    /////////////
    ...
    private void initComponents() {
        ...
        m_jButtonPrint.setForeground(new java.awt.Color(240, 240, 240));
        m_jButtonPrint.setSelected(true);
        m_jButtonPrint.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
