	...
	public void gotoHyperlink(JRPrintHyperlink hyperlink)
	{
		switch(hyperlink.getHyperlinkType())
		{
			case JRHyperlink.HYPERLINK_TYPE_REFERENCE :
			{
				...
				{
					System.out.println("Hipervínculo de referencia: " + hyperlink.getHyperlinkReference());
					System.out.println("Puedes implementar tu propia JRHyperlinkListener para gestionar este tipo de eventos.");
				}
				break;
			}
			...
			case JRHyperlink.HYPERLINK_TYPE_REMOTE_ANCHOR :
			{
				...
				{
					System.out.println("Hipervínculo de referencia: " + hyperlink.getHyperlinkReference());
					System.out.println("Hipervínculo de anclaje: " + hyperlink.getHyperlinkAnchor());
					System.out.println("Puedes implementar tu propia JRHyperlinkListener para gestionar este tipo de eventos.");
				}
				break;
			}
			case JRHyperlink.HYPERLINK_TYPE_REMOTE_PAGE :
			{
				...
				{
					System.out.println("Hipervínculo de referencia: " + hyperlink.getHyperlinkReference());
					System.out.println("Hipervínculo de la página: " + hyperlink.getHyperlinkPage());
					System.out.println("Puedes implementar tu propia JRHyperlinkListener para gestionar este tipo de eventos.");
				}
				break;
			}
			case JRHyperlink.HYPERLINK_TYPE_CUSTOM:
			{
				if (isOnlyHyperlinkListener())
				{
					System.out.println("Tipo del hipervínculo: " + hyperlink.getLinkType());
					System.out.println("Puedes implementar tu propia JRHyperlinkListener para gestionar este tipo de eventos.");
				}
				break;
			}
